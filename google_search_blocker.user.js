...
(async function code() {
    ...
    const GoogleSearchBlock = (function () {
        ...
        GoogleSearchBlock.createButton = function (pattern, fragment) {
            ...
            span.addEventListener('click', GoogleSearchBlock.commentout);
            ...
            R_.commentout.addEventListener('click', GoogleSearchBlock.deleterule);
                ...
                document.querySelectorAll(target.first).forEach(e => {
                    ...
                    if ((link_ = e.querySelector(target.second)) &&
                        ...
                        if (self.redisplayed) {
                            e.isredisplay = false;
                            e.style.display = 'none';
                            self.innerHTML = '<i class="fas fa-eye"></i>';
                        } else {
                            e.isredisplay = true;
                            e.style.display = 'block';
                            self.innerHTML = '<i class="fas fa-eye-slash"></i>';
                        }
                        return;
                    }
                });
            });
            self.redisplayed = !self.redisplayed;
